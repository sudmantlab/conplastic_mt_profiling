...
plotting_df = copy_num_cleaned %>%
  ...
  summarise(AVG = mean(mGE.nGE), SE = sd(mGE.nGE)/sqrt(n())) %>%
...
mtdna_cn = ggplot(plotting_df, aes(x = STRAIN, y = AVG, fill = Age)) + 
